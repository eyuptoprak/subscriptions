...
class GoogleCheckSubscriptionJob implements ShouldQueue
{
    ...
    public function __construct($receipt)
    {
        ...
        $this->requestData['username'] = config('google.api.username');
        $this->requestData['password'] = config('google.api.password');
        $this->googleSubscriptionURL = config('google.api.uri') . 'checkReceipt';
    }
